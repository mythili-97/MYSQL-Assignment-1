...
### Installing
Sql script is store in folder we can run sql program using MYSQL Workbench for the desired output


### Executing program
Program can be run in MYSQL Workbench,Database are created which we can view in the left side of the page.Using various SQL commands and constraints database and table are created. 
